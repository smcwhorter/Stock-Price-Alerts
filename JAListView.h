...
@interface JAListView : NSView {
    ...
    __unsafe_unretained id<JAListViewDataSource> dataSource;
    __unsafe_unretained id<JAListViewDelegate> delegate;
    __unsafe_unretained id<JAListViewDraggingSourceDelegate> draggingSourceDelegate;
    __unsafe_unretained id<JAListViewDraggingDestinationDelegate> draggingDestinationDelegate;
...
@property (nonatomic, assign) __unsafe_unretained IBOutlet id<JAListViewDataSource> dataSource;
@property (nonatomic, assign) __unsafe_unretained IBOutlet id<JAListViewDelegate> delegate;
@property (nonatomic, assign) __unsafe_unretained IBOutlet id<JAListViewDraggingSourceDelegate> draggingSourceDelegate;
@property (nonatomic, assign) __unsafe_unretained IBOutlet id<JAListViewDraggingDestinationDelegate> draggingDestinationDelegate;
